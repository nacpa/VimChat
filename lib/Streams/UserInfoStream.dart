                          ...
                          children: [
                            ...
                            Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                Text(Users[Pos]["Email"].toString(),overflow: TextOverflow.ellipsis,maxLines: 1,
                                    style: TextStyle(
                                        fontSize: Dim.Hight10*1.9,
                                        fontStyle: FontStyle.normal,
                                        letterSpacing: 1,
                                        fontWeight: FontWeight.w500)),
                                Text(Users[Pos]["Gender"].toString(),overflow: TextOverflow.ellipsis,maxLines: 1,
                                    style: TextStyle(
                                        fontSize: Dim.Hight10*1.7,
                                        fontStyle: FontStyle.normal,
